...
A_0 X_t=∑_(i=1)^k▒〖A_i X_(t-i)+ ε_t 〗
...
[█(■(e_(Ls,t)@e_(ind,t)@e_(exch,t)@e_(PPI,t) )@e_(int,t) )]  = [■(β_11&0&0&0&0@β_21&β_22&0&0&0@β_31&β_32&β_33&0&0@β_41&β_42&β_43&β_44&0@β_51&β_52&β_53&β_54&β_55 )][█(■(ε_(Ls,t)@ε_(ind,t)@ε_(exch,t)@ε_(PPI,t) )@ε_(int,t) )]
...
knitr::include_graphics("~/R/colekehrberg/Economics/ECON385Figure1.png") #uploads image of word cloud for pdf render
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
knitr::include_graphics("~/R/colekehrberg/Economics/ECON385Figure2.png") #uploads image of word cloud for pdf render
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
knitr::include_graphics("~/R/colekehrberg/Economics/ECON385Figure3.png") #uploads image of word cloud for pdf render
```

Figure 3: Full VAR-X model for PPI (intermediate manufactured goods)
 
```{r, echo = FALSE, message = FALSE, warning = FALSE}
knitr::include_graphics("~/R/colekehrberg/Economics/ECON385Figure4.png") #uploads image of word cloud for pdf render
```
 
Figure 4: Full VAR-X model for PPI (mining)

```{r, echo = FALSE, message = FALSE, warning = FALSE}
knitr::include_graphics("~/R/colekehrberg/Economics/ECON385Figure5.png") #uploads image of word cloud for pdf render
```
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
knitr::include_graphics("~/R/colekehrberg/Economics/ECON385Figure6.png") #uploads image of word cloud for pdf render
``` 
